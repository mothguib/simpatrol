...
public class HS_SCLauncher extends Launcher {
	String env_file;
	
	
	
	public HS_SCLauncher(String environment_dir_path,
	...
	public static void main(String[] args) {
		...
		try {
			...
			HS_SCLauncher client = new HS_SCLauncher(
			...
			System.out
					.println("Usage \"java -jar SC.HS_SCLauncher.jar \n"
							+ "<IP address> <Remote socket number> <Environment file path>\n"
							+ "<Log file name> <Time of simulation>\"");
		}
	}
