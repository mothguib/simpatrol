...
public class HS_SpeechAct { 
	...
	public HS_SpeechAct(int id, SpeechActPerformative performative, String sender,
			String receiver, LinkedList<String> contained_nodes, int option, int deadline){
	...
	public HS_SpeechAct(int id, SpeechActPerformative performative, String sender,
			String receiver, LinkedList<String> contained_nodes, 
			double happiness_a, double happiness_b, int deadline){
		this.transaction_id = id;
		this.setPerformative(performative);
		this.setSender(sender);
		this.setReceiver(receiver);
	...
	public HS_SpeechAct(int id, SpeechActPerformative performative, String sender,
			String receiver, int[] idleness, int deadline){
		this.transaction_id = id;
		this.setPerformative(performative);
		this.setSender(sender);
		this.setReceiver(receiver);
	...
	public HS_SpeechAct(int id, SpeechActPerformative performative, String sender,
			String receiver, ComplexBid bid, int deadline){
		this.transaction_id = id;
		this.setPerformative(performative);
		this.setSender(sender);
		this.setReceiver(receiver);
	...
	public String toString(){
		String str = "<ACT trans_id=\"" + this.transaction_id + "\" perf=\"" + performative + "\" deadline=\"" + deadline + "\">";
	...
	public static HS_SpeechAct fromString(String str){	
		if(adapt_to_simpatrol){
			str = str.replace('(','<');
			str = str.replace(')','>');
	    	str = str.replace('\'', '"');
		...
		String deadline_str = str.substring(str.indexOf("<ACT"), str.indexOf(">"));
		deadline_str = deadline_str.substring(deadline_str.indexOf("deadline=\"") + 10);
		deadline_str = deadline_str.substring(0, deadline_str.indexOf("\""));
		deadline = Integer.valueOf(deadline_str);
		...
		act = new HS_SpeechAct(trans_id, perf, sender, receiver, complexBid, deadline);
	...
	public boolean equals(HS_SpeechAct act){
