...
public class AgentGUI extends JDialog {	
    ...
    public AgentGUI(JDialog owner, Society society, Agent agent, Environment env) {
        super(owner, true);
    	this.initComponents();
    	this.initComponents2(agent, society, env);                
    }
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setBounds((screenSize.width-580)/2, (screenSize.height-540)/2, 580, 620);
     ...
     *  @param graph The graph of the patrolling simulation. */
    private void initComponents2(Agent agent, Society society, Environment env) {
    	this.agent = agent;
    	this.agents = null;
    	this.agent_panel = new AgentJPanel(this, society, agent, env);
    ...
    private void ok_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ok_buttonActionPerformed
    	if(!this.agent_panel.check_times())
    		return;
