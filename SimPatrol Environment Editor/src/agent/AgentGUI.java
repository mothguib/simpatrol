...
public class AgentGUI extends JDialog {
	 ...
	 * @param agent
	 *            The Agent object to be configured by the GUI.
	 * @param graph
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 580) / 2, (screenSize.height - 540) / 2,
				580, 540);
	...
	private void initComponents2(Agent agent, Graph graph) {
		...
		if (agent instanceof PerpetualAgent)
			this.type_label.setText("Perpetual agent");
		else
			this.type_label.setText("Seasonal agent");
	}

	/**
	 * Executed when the copies_spinner changes. Generated by NetBeans IDE 3.6.
	 */
	...
	private void ok_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ok_buttonActionPerformed
		int copies_count = ((Integer) this.copies_spinner.getValue())
				.intValue();
		...
		if (this.agents.length > 1)
			for (int i = 0; i < this.agents.length; i++)
				this.agents[i].setObjectId(this.agents[i].getObjectId() + "$"
						+ String.valueOf(i));
