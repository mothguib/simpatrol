...
/**
 * Implements the GUI panel able to configure Agent objects.
 * 
 * @see Agent
 */
public class AgentJPanel extends javax.swing.JPanel {
	 ...
	 * @param agent
	 *            The Agent object to be configured.
	 * @param graph
	...
	private void initComponents() {
		...
		identification_panel.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), "Identification"));
		...
		position_panel.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), "Position"));
		...
		elapsed_length_panel.add(elapsed_length_label,
				java.awt.BorderLayout.WEST);

		elapsed_length_field
		...
		elapsed_length_panel.add(elapsed_length_field,
				java.awt.BorderLayout.CENTER);

		position_panel.add(elapsed_length_panel);

		position_stamina_allowance_panel.add(position_panel,
				java.awt.BorderLayout.NORTH);

		agent_stamina_panel.setLayout(new java.awt.GridLayout(2, 0));

		agent_stamina_panel.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), "Stamina"));
		...
		max_stamina_internal_panel.add(max_stamina_label,
				java.awt.BorderLayout.WEST);
		...
		max_stamina_internal_panel.add(max_stamina_field,
				java.awt.BorderLayout.CENTER);

		agent_stamina_panel.add(max_stamina_internal_panel);

		position_stamina_allowance_panel.add(agent_stamina_panel,
				java.awt.BorderLayout.CENTER);
		...
		broadcast_perception_panel.add(broadcast_perception_check,
				java.awt.BorderLayout.CENTER);

		broadcast_perception_button.setText("Edit");
		broadcast_perception_button.setEnabled(false);
		broadcast_perception_button
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		broadcast_perception_panel.add(broadcast_perception_button,
		...
		action_allowance_panel.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(), "Allowed actions"));
		broadcast_action_panel.setLayout(new java.awt.BorderLayout());

		broadcast_action_check.setText("Broadcast message");
		broadcast_action_check
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		broadcast_action_panel.add(broadcast_action_button,
				java.awt.BorderLayout.EAST);
		...
		position_stamina_allowance_panel.add(allowance_panel,
				java.awt.BorderLayout.SOUTH);

		main_panel.add(position_stamina_allowance_panel,
				java.awt.BorderLayout.CENTER);

		death_panel.setLayout(new java.awt.BorderLayout());

		death_panel.setBorder(new javax.swing.border.TitledBorder(
				new javax.swing.border.EtchedBorder(),
				"Death time probability distribution"));
		...
		death_combo.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				"None", "Uniform", "Empirical", "Normal", "Specific time" }));
	...
	public void initComponents2(JDialog owner, Agent agent, Graph graph) {
		...
		this.max_stamina_field.setText(String.valueOf(this.agent
				.getMax_stamina()));

		PerceptionPermission[] allowed_permissions = this.agent
		...
		if (this.agent instanceof SeasonalAgent) {
			...
			this.death_panel.setVisible(false);
	}

	/**
	 * Executed when the depth_combo object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void death_comboActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_death_comboActionPerformed
		if (this.death_combo.isEnabled()
				&& (this.last_death_combo_index != this.death_combo
						.getSelectedIndex())) {
			...
			if (this.death_combo.getSelectedIndex() == 0)
				...
				if (this.death_combo.getSelectedIndex() == 1)
					this.death_gui = new EventTimeProbabilityDistributionGUI(
							this.owner,
							new UniformEventTimeProbabilityDistribution(
									(int) System.currentTimeMillis(), 0));
				else if (this.death_combo.getSelectedIndex() == 2) {
					double[] ditribution = { 1 };
					this.death_gui = new EventTimeProbabilityDistributionGUI(
							this.owner,
							new EmpiricalEventTimeProbabilityDistribution(
									(int) System.currentTimeMillis(),
									ditribution));
				} else if (this.death_combo.getSelectedIndex() == 3)
					this.death_gui = new EventTimeProbabilityDistributionGUI(
							this.owner,
							new NormalEventTimeProbabilityDistribution(
									(int) System.currentTimeMillis(), 0, 0));
				else
					this.death_gui = new EventTimeProbabilityDistributionGUI(
							this.owner,
							new SpecificEventTimeProbabilityDistribution(
									(int) System.currentTimeMillis(), 0, 0));

				this.death_gui.setVisible(true);

				EventTimeProbabilityDistribution chosen_death_tpd = this.death_gui
						.getETPD();
				if (chosen_death_tpd == null) {
					...
					this.death_tpd = chosen_death_tpd;
			}
		}
	}// GEN-LAST:event_death_comboActionPerformed

	/**
	 * Executed when the death_button is pressed. Generated by NetBeans IDE 3.6.
	 */
	private void death_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_death_buttonActionPerformed
		this.death_gui = new EventTimeProbabilityDistributionGUI(this.owner,
				this.death_tpd);
		this.death_gui.setVisible(true);
		EventTimeProbabilityDistribution chosen_death_tpd = this.death_gui
				.getETPD();
	...
	/**
	 * Executed when the visit_button is pressed. Generated by NetBeans IDE 3.6.
	 */
	private void visit_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_visit_buttonActionPerformed
		this.permission_gui = new PermissionGUI(this.owner,
				this.visit_action_permission);
	...
	/**
	 * Executed when the stigmatize_button is pressed. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void stigmatize_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_stigmatize_buttonActionPerformed
		this.permission_gui = new PermissionGUI(this.owner,
				this.stigmatize_action_permission);
		this.permission_gui.setVisible(true);
	...
	/**
	 * Executed when the recharge_button is pressed. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void recharge_buttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_recharge_buttonActionPerformed
		this.permission_gui = new PermissionGUI(this.owner,
				this.recharge_action_permission);
		this.permission_gui.setVisible(true);
	...
	/**
	 * Executed when the broadcast_action_button is pressed. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void broadcast_action_buttonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_broadcast_action_buttonActionPerformed
		this.permission_gui = new PermissionGUI(this.owner,
				this.broadcast_action_permission);
		this.permission_gui.setVisible(true);
	...
	/**
	 * Executed when the broadcast_perception_button is pressed. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void broadcast_perception_buttonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_broadcast_perception_buttonActionPerformed
		this.permission_gui = new PermissionGUI(this.owner,
				this.broadcast_perception_permission);
		this.permission_gui.setVisible(true);
	...
	/**
	 * Executed when the goto_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void goto_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_goto_checkActionPerformed
		if (this.goto_check.isSelected()) {
			if (this.goto_action_permission == null)
				this.goto_action_permission = new ActionPermission(null,
						ActionTypes.GOTO);
	...
	/**
	 * Executed when the broadcast_action_check object changes. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void broadcast_action_checkActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_broadcast_action_checkActionPerformed
		if (this.broadcast_action_check.isSelected()) {
			if (this.broadcast_action_permission == null)
				this.broadcast_action_permission = new ActionPermission(null,
	...
	/**
	 * Executed when the recharge_check object changes. Generated by NetBeans
	 * IDE 3.6.
	 */
	private void recharge_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_recharge_checkActionPerformed
		if (this.recharge_check.isSelected()) {
			if (this.recharge_action_permission == null)
				this.recharge_action_permission = new ActionPermission(null,
	...
	/**
	 * Executed when the stigmatize_check object changes. Generated by NetBeans
	 * IDE 3.6.
	 */
	private void stigmatize_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_stigmatize_checkActionPerformed
		if (this.stigmatize_check.isSelected()) {
			if (this.stigmatize_action_permission == null)
				this.stigmatize_action_permission = new ActionPermission(null,
	...
	/**
	 * Executed when the visit_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void visit_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_visit_checkActionPerformed
		if (this.visit_check.isSelected()) {
			if (this.visit_action_permission == null)
				this.visit_action_permission = new ActionPermission(null,
						ActionTypes.VISIT);
	...
	/**
	 * Executed when the stigma_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void stigma_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_stigma_checkActionPerformed
		if (this.stigma_check.isSelected()) {
			if (this.stigma_perception_permission == null)
				this.stigma_perception_permission = new PerceptionPermission(
						null, PerceptionTypes.STIGMAS);
	...
	/**
	 * Executed when the graph_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void graph_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_graph_checkActionPerformed
		if (this.graph_check.isSelected()) {
			if (this.graph_perception_permission == null)
				this.graph_perception_permission = new PerceptionPermission(
						null, PerceptionTypes.GRAPH);
	...
	/**
	 * Executed when the agent_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void agent_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_agent_checkActionPerformed
		if (this.agent_check.isSelected()) {
			if (this.agent_perception_permission == null)
				this.agent_perception_permission = new PerceptionPermission(
						null, PerceptionTypes.AGENTS);
	...
	/**
	 * Executed when the broadcast_perception_check object changes. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void broadcast_perception_checkActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_broadcast_perception_checkActionPerformed
		if (this.broadcast_perception_check.isSelected()) {
			if (this.broadcast_perception_permission == null)
				this.broadcast_perception_permission = new PerceptionPermission(
						null, PerceptionTypes.BROADCAST);
	...
	/**
	 * Executed when the self_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void self_checkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_self_checkActionPerformed
		if (this.self_check.isSelected()) {
			if (this.self_perception_permission == null)
				this.self_perception_permission = new PerceptionPermission(
						null, PerceptionTypes.SELF);
	...
	/**
	 * Executed when the max_stamina_field object changes. Generated by NetBeans
	 * IDE 3.6.
	 */
			...
			try {
				...
				if (str_max_stamina.charAt(str_max_stamina.length() - 1) != '.') {
					JOptionPane
							.showMessageDialog(
									this,
									"The maximum stamina value must be a real non-negative number.",
									"Stamina value error.",
	...
	/**
	 * Executed when the stamina_field object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
			...
			try {
				...
				if (str_stamina.charAt(str_stamina.length() - 1) != '.') {
					JOptionPane
							.showMessageDialog(
									this,
									"The stamina value must be a real non-negative number.",
									"Stamina value error.",
									JOptionPane.ERROR_MESSAGE);
	...
	/**
	 * Executed when the elapsed_length_field object changes. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void elapsed_length_fieldKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_elapsed_length_fieldMouseReleased
		...
		if (str_length.length() > 0) {
			...
			try {
				...
				if (elapsed_length < 0
						|| elapsed_length > this.max_elapsed_length)
					throw new NumberFormatException();
			} catch (NumberFormatException e) {
				if (elapsed_length > this.max_elapsed_length) {
					JOptionPane.showMessageDialog(this,
							"The maximum value of the elapsed length is "
									+ String.valueOf(this.max_elapsed_length),
					...
					JOptionPane
							.showMessageDialog(
									this,
									"The elapsed length value must be a real non-negative number.",
									"Value error.", JOptionPane.ERROR_MESSAGE);
					this.elapsed_length_field.setText("0");
				}
			}
	...
	/**
	 * Executed when the edge_combo object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
		...
		if (this.edge_combo.getSelectedIndex() == 0) {
			...
			for (int i = 0; i < edges.length; i++)
				if (edges[i].getObjectId().equals(edge_id)) {
					...
					this.elapsed_length_field.setToolTipText("Max value: "
							+ String.valueOf(this.max_elapsed_length));
					return;
				}
		}
	...
	/**
	 * Executed when the vertex_combo object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	...
	/**
	 * Executed when the label_field object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void label_fieldKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_label_fieldActionPerformed
		...
		String id_part = null;
		StringTokenizer tokenizer = new StringTokenizer(this.object_id_field
				.getText().trim(), "@", false);
		try {
			tokenizer.nextToken();
	...
	public Agent getAgent() {
		...
		if (this.vertex_combo.getSelectedIndex() == 0) {
			...
			while (random_index == 0)
				random_index = (int) (Math.random() * (this.vertex_combo
						.getItemCount()));
		...
		if (this.edge_combo.getSelectedIndex() > 0) {
			...
			try {
				elapsed_length = Double.parseDouble(this.elapsed_length_field
						.getText().trim());
			} catch (NumberFormatException e) {
		...
		try {
			max_stamina = Double.parseDouble(this.max_stamina_field.getText()
					.trim());
		} catch (NumberFormatException e) {
		...
		if (max_stamina < stamina) {
			JOptionPane
					.showMessageDialog(
							this,
							"The stamina value cannot be bigger than the maximum possible stamina value. Its value will be reset.",
							"Stamina value error", JOptionPane.ERROR_MESSAGE);
			stamina = max_stamina;
		...
		PerceptionPermission[] allowed_perceptions = new PerceptionPermission[allowed_perceptions_list
				.size()];
		...
		ActionPermission[] allowed_actions = new ActionPermission[allowed_actions_list
				.size()];
		for (int i = 0; i < allowed_actions.length; i++)
		...
		if (this.agent instanceof PerpetualAgent)
			answer = new PerpetualAgent(label, vertex, allowed_perceptions,
					allowed_actions);
		else {
			if (this.death_combo.getSelectedIndex() != 0)
				answer = new SeasonalAgent(label, vertex, allowed_perceptions,
						allowed_actions, this.death_tpd);
			else
				answer = new SeasonalAgent(label, vertex, allowed_perceptions,
