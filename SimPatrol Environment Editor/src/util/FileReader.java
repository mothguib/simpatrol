...
public class FileReader {
    ...
    public String readLine() throws IOException {
    	if(this.lines_count <= 0) return null;
     ...
     * 
     *  @param string The string obtained from the file to be read. 
    ...
    private int appendLine(String string) {
        ...
        if(this.first_line + this.lines_count >= this.buffer.length) {
        	...
        	System.arraycopy(src, this.first_line, this.buffer, 0, this.lines_count);
