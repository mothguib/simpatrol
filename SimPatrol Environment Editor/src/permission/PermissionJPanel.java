...
/**
 * Implements the GUI panel able to configure Permission objects.
 * 
 * @see Permission
 */
public class PermissionJPanel extends javax.swing.JPanel {
	 ...
	 * 
	 * @param owner
	 *            The GUI that contains this panel.
	 * @param permission
	 *            The Permission object to be configured.
	 * @param deth_visibility
	 *            TRUE if the depth_limitation internal panel must appear, FALSE
	 *            if not.
	 * @param stamina_visibility
	 *            TRUE if the stamina_limitation internal panel must appear,
	 *            FALSE if not.
	 * @param speed_visibility
	 *            TRUE if the speed_limitation internal panel must appear, FALSE
	 *            if not.
	 * @param acceleration_visibility
	 *            TRUE if the acceleration_limitation internal panel must
	 *            appear, FALSE if not.
	 */
	public PermissionJPanel(JDialog owner, Permission permission,
			boolean depth_visibility, boolean stamina_visibility,
			boolean speed_visibility, boolean acceleration_visibility) {
		this.initComponents();
		this.initComponents2(owner, permission, depth_visibility,
				stamina_visibility, speed_visibility, acceleration_visibility);
	}
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		depth_limitation_panel.add(depth_edit_button,
		...
		stamina_limitation_panel.add(stamina_check,
		...
		stamina_limitation_panel.add(stamina_edit_button,
				java.awt.BorderLayout.EAST);
		...
		speed_limitation_panel.add(speed_edit_button,
				java.awt.BorderLayout.EAST);
		...
		acceleration_limitation_panel.add(acceleration_edit_button,
				java.awt.BorderLayout.EAST);
	...
	/**
	 * Executed when the depth_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	private void stamina_checkItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_stamina_checkItemStateChanged
		if (this.stamina_check.isEnabled() && this.stamina_check.isSelected()) {
			...
			this.limitation_gui = new LimitationGUI(this.owner,
					this.stamina_limitation);
	...
	/**
	 * Executed when the speed_check object changes. Generated by NetBeans IDE
	 * 3.6.
	 */
	...
	/**
	 * Executed when the acceleration_check object changes. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void acceleration_checkItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_acceleration_checkItemStateChanged
		if (this.acceleration_check.isEnabled()
				&& this.acceleration_check.isSelected()) {
			if (this.acceleration_limitation == null)
				this.acceleration_limitation = new AccelerationLimitation(1);

			this.limitation_gui = new LimitationGUI(this.owner,
					this.acceleration_limitation);
			this.limitation_gui.setVisible(true);
	...
	/**
	 * Executed when the stamina_edit_button is pressed. Generated by NetBeans
	 * IDE 3.6.
	 */
	private void stamina_edit_buttonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_stamina_edit_buttonActionPerformed
		this.limitation_gui = new LimitationGUI(this.owner,
				this.stamina_limitation);
		this.limitation_gui.setVisible(true);
	...
	/**
	 * Executed when the depth_edit_button is pressed. Generated by NetBeans IDE
	 * 3.6.
	 */
	...
	/**
	 * Executed when the speed_edit_button is pressed. Generated by NetBeans IDE
	 * 3.6.
	 */
	...
	/**
	 * Executed when the acceleration_edit_button is pressed. Generated by
	 * NetBeans IDE 3.6.
	 */
	private void acceleration_edit_buttonActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_acceleration_edit_buttonActionPerformed
		this.limitation_gui = new LimitationGUI(this.owner,
				this.acceleration_limitation);
		this.limitation_gui.setVisible(true);
