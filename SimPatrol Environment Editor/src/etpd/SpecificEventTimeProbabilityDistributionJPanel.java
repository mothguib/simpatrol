 ...
 */
public class SpecificEventTimeProbabilityDistributionJPanel extends
	 ...
	 * 
	 * @param etpd
	 *            The SpecificEventTimeProbabilityDistribution object to be
	 *            configured.
	 */
	public SpecificEventTimeProbabilityDistributionJPanel(
			...
			try {
				...
				if (str_probability.charAt(str_probability.length() - 1) != '.') {
					JOptionPane.showMessageDialog(this,
							"The probability value must be a real number.",
	...
	/**
	 * Executed when the time_field changes. Generated by NetBeans IDE 3.6.
	 */
		...
		if (str_time.length() > 0)
			try {
				...
				JOptionPane.showMessageDialog(this,
						...
						"Time value error.", JOptionPane.ERROR_MESSAGE);
	...
	public model.etpd.EventTimeProbabilityDistribution getETPD() {
		try {
			...
			this.etpd = new SpecificEventTimeProbabilityDistribution(seed,
					probability, time);
		} catch (NumberFormatException e) {
			JOptionPane.showMessageDialog(this,
					"The time and probability values must be correct.",
					"Probability value error.", JOptionPane.ERROR_MESSAGE);
