...
public class EventTimeProbabilityDistributionGUI extends JDialog {
	 ...
	 * @param etpd
	 *            The event time probability distribution to be configured.
	 */
	public EventTimeProbabilityDistributionGUI(JDialog owner,
			EventTimeProbabilityDistribution etpd) {
		super(owner, true);
		this.initComponents();
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 408) / 2, (screenSize.height - 327) / 2,
				408, 327);
	 ...
	 * 
	 * @param etpd
	 *            The event time probability distribution to be configured by
	 *            the GUI.
	 */
	private void initComponents2(EventTimeProbabilityDistribution etpd) {
		...
		if (etpd instanceof UniformEventTimeProbabilityDistribution) {
			this.etpd_panel = new UniformEventTimeProbabilityDistributionJPanel(
			...
			this.etpd_panel = new EmpiricalEventTimeProbabilityDistributionJPanel(
			...
			this.etpd_panel = new NormalEventTimeProbabilityDistributionJPanel(
					(NormalEventTimeProbabilityDistribution) etpd);
			this.type_label.setText("Normal distribution");
		} else {
			this.etpd_panel = new SpecificEventTimeProbabilityDistributionJPanel(
					(SpecificEventTimeProbabilityDistribution) etpd);
	...
	/**
	 * Executed when the editing_panel has its current tab changed. Generated by
	 * NetBeans IDE 3.6.
	 */
