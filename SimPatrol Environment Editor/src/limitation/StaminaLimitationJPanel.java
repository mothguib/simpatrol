...
/**
 * Implements the GUI panel able to configure StaminaLimitation objects.
 * 
...
public class StaminaLimitationJPanel extends LimitationJPanel {
	 ...
	 * 
	 * @param limitation
	 *            The StaminaLimitation object to be configured.
	 */
	...
	/**
	 * Executed when the cost_field changes. Generated by NetBeans IDE 3.6.
	 */
			...
			try {
				...
				if (str_cost.charAt(str_cost.length() - 1) != '.') {
					JOptionPane
							.showMessageDialog(
									this,
									"The stamina cost must be a real non-negative number.",
									"Cost error.", JOptionPane.ERROR_MESSAGE);
