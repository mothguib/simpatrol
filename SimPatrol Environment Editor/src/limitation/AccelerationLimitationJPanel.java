 ...
 *  AccelerationLimitation objects.
 *  
...
public class AccelerationLimitationJPanel extends LimitationJPanel {	
    ...
    /** Constructor.
     * 
     *  @param limitation The AccelerationLimitation object to be configured. */
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        acceleration_panel.add(acceleration_field, java.awt.BorderLayout.CENTER);
    ...
    private void initComponents(AccelerationLimitation limitation) {
    	...
    	this.acceleration_field.setText(String.valueOf(this.limitation.getAcceleration()));
    }
    
    /** Executed when the speed_field changes.
     *  Generated by NetBeans IDE 3.6. */
        ...
        if(str_acceleration.length() > 0)
            try {
                ...
                if(str_acceleration.charAt(str_acceleration.length() - 1) != '.') {
                    JOptionPane.showMessageDialog(this, "The acceleration value must be a real non-negative number.", "Value error.", JOptionPane.ERROR_MESSAGE);
	...
	public Limitation getLimitation() {
        try {
            double acceleration = Double.parseDouble(this.acceleration_field.getText().trim());
