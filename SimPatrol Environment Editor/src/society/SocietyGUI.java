...
public class SocietyGUI extends javax.swing.JDialog {
	 ...
	 * @param society
	 *            The Society object to be configured by the GUI.
	 * @param graph
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 600) / 2, (screenSize.height - 550) / 2,
				600, 550);
	...
	private void initComponents2(Society society, Graph graph) {
		...
		if (society instanceof ClosedSociety)
			this.society_label.setText("Closed society");
		else
			this.society_label.setText("Open society");
	}
	...
	/**
	 * Returns the society configured by this GUI.
	 * 
