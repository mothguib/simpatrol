...
public class SocietyJPanel extends javax.swing.JPanel {   
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        randstart_button = new javax.swing.JButton();
        ...
        buttons_internal_panel.setLayout(new java.awt.GridLayout(4, 0));
        ...
        randstart_button.setText("Randomize positions");
        randstart_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                randstart_buttonActionPerformed(evt);
            }
        });

        buttons_internal_panel.add(randstart_button);
    ...
    /** Executed when the randstart_button is pressed.
     *  
     *  @author Cyril Poulet
     **/
    protected void randstart_buttonActionPerformed(ActionEvent evt) {
    ...
    private javax.swing.JButton randstart_button;
