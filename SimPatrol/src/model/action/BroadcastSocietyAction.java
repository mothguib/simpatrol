 ...
 */
public final class BroadcastSocietyAction extends AtomicAction {
	/* Attributes. */
	 ...
	 *            reach.
	 */
	public BroadcastSocietyAction(String message, int message_depth) {
	...
	public String fullToXML(int identation) {
		...
		// fills the buffer
		buffer.append("<action type=\"" + ActionTypes.BROADCAST_SOCIETY
