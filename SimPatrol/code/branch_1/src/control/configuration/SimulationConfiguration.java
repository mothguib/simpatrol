...
public final class SimulationConfiguration extends Configuration {
	/* Attributes. */
	...
	public SimulationConfiguration(String sender_address, int sender_socket, int simulation_time) {
	...
	protected int getType() {
		return ConfigurationTypes.SIMULATION_CONFIGURATION; 
	}
