...
/** Implements the metrics of the patrolling task whose value
 *  must be calculated regularly. */
public abstract class IntegralMetric extends Metric implements Clockable{
	...
	/** Constructor.
	 *  
	 *  @param thread_name The name of the thread of the clock of the metric.
