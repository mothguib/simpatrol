...
/** Implements the probability distributions of hapenning an event,
...
public abstract class EventTimeProbabilityDistribution implements XMLable {
	 ...
	 *  @developer This method must be overriden, in order to the rn_distributor attribute be intantiated. */
	 ...
	 *  @developer The next_bool_counter attribute must be increased, when this method is implemented, before any code. */
