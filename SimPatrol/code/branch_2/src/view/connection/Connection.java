...
/** The connections offered by SimPatrol
 *  in order to contact the remote actors.
 *  
...
public abstract class Connection extends Thread {
	...
	/** Constructor.
	 * 
	 *  @param thread_name The name of the thread of the connection.
	 ...
	 * 
	 *  @param The number of the socket of the connection.
	 *  @throws IOException */
