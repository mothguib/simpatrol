...
public class SimPatrolGUI extends javax.swing.JFrame {
	...
	private JPanel configuration_panel;
    	private JPanel configuration_internal_panel;
    		...
    		private JPanel atualization_rate_panel;
    			private JLabel atualization_rate_label;
	...
	private void initWindow() {
        ...
        this.atualization_rate_label = new JLabel();
        this.configuration_panel.setLayout(new BorderLayout());
        this.configuration_panel.setBorder(new TitledBorder(""));
        this.configuration_internal_panel.setLayout(new GridLayout(1, 2, 15, 0));
        ...
        this.atualization_rate_panel.add(this.atualization_rate_label, BorderLayout.WEST);
        this.configuration_internal_panel.add(this.atualization_rate_panel);
        this.configuration_panel.add(this.configuration_internal_panel, BorderLayout.WEST);
	...
	/** Configures the simulation mode, as well as the port number of the simulator
	 *  and its atualization time rate.
	 *  
	 *  @param is_real_time_simulation TRUE is the simulation mode is real time, FALSE if not.
	 *  @param port_number The number of the port of the simulator. 
	 *  @param atualization_time_rate The atualization time rate of the simulator. */
	public void configureSimulation(boolean is_real_time_simulation, int port_number, double atualization_time_rate) {
		this.port_label.setText("Port: " + port_number);
		this.atualization_rate_label.setText("Atualization rate: " + atualization_time_rate + " sec");
		
		try {
			if(is_real_time_simulation) {
				((TitledBorder) this.configuration_panel.getBorder()).setTitle("Real time simulator");
				this.simulator = new RealTimeSimulator(port_number, atualization_time_rate);
			}
			else {
				((TitledBorder) this.configuration_panel.getBorder()).setTitle("Cycled simulator");
				this.simulator = new CycledSimulator(port_number, atualization_time_rate);
			}
		}
