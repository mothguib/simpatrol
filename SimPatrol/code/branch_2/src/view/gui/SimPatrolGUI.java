...
public class SimPatrolGUI extends javax.swing.JFrame {
	...
	private void initWindow() {
		...
		this.atualization_rate_panel.add(this.atualization_rate_label,
				BorderLayout.WEST);
	 ...
	 * simulator and its atualization time rate.
	 * 
	 ...
	 * @param atualization_time_rate
	 *            The atualization time rate of the simulator.
	 */
	public void configureSimulation(boolean is_real_time_simulation,
			int port_number, double atualization_time_rate) {
		this.port_label.setText("Port: " + port_number);
		this.atualization_rate_label.setText("Atualization rate: "
				+ atualization_time_rate + " sec");
