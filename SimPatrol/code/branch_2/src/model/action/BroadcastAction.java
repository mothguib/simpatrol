...
/** Implements the action of broadcasting a message 
 *  through the graph.
 * 
...
public final class BroadcastAction extends AtomicAction {
	 ...
	 *  @param message_depth The depth of the graph that the broadcasted message must reach. */
	...
	public String fullToXML(int identation) {
		...
		// fills the buffer	
		buffer.append("<action type=\"" + ActionTypes.VISIT_ACTION +
				      "\" message=\"" + this.message +
				      "\" message_depth=\"" + this.message_depth +
				      "\"/>\n");
