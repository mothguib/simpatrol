...
/**
 * Implements the probability distributions of hapenning an event, based on the
 * time of simulation.
 * 
...
public abstract class EventTimeProbabilityDistribution implements XMLable {
	 ...
	 * @developer This method must be overriden, in order to the rn_distributor
	 *            attribute be intantiated.
	 */
	...
	/**
	 * Configures the next_bool_counter attribute, and assures the distribuitor
	 * consistence.
	 */
