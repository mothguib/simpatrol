...
public class Vertex implements XMLable, Visible {
	...
	/** Returns the vertexes in the neighbourhood of which
	 *  emitter is this one.
	 * 
	 *  @return The set of vertexes in the neighbourhood of which emitter is this one. */
	 ...
	 * 
	 *  @param vertex The adjacent vertex of which edges shared with this vertex are to be returned.
	...
	/** Returns all the edges between this vertex and the given one,
	 *  of which emitter is this vertex.
	 * 
	 *  @param vertex The adjacent vertex of which edges shared with this vertex are to be returned.
	 *  @return The edges in common between this vertex and the given one, of which emitter is this vertex. */
