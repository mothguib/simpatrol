...
/** Implements the limitations that control the acceleration of the movement
...
public final class AccelerationLimitation extends Limitation {
	...
	/** Constructor.
	 * 
	 *  @param acceleration The acceleration limit, measured in depth/sec^2 or depth/cycle^2. */
	...
	public String fullToXML(int identation) {
		...
		// fills the buffer
		buffer.append("<limitation type=\"" + LimitationTypes.ACCELERATION_LIMITATION + "\">\n");
