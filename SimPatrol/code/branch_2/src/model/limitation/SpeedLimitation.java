...
/** Implements the limitations that control the speed of the movement
 *  in a permission that lets an agent move through the graph to be patrolled.
 *  
 *  Or...
 *  
 *  Implements the limitations that control the speed of recharging
 *  in a permission that lets an agent recharge its stamina value.
 *  
 *  @see GoToAction
...
public class SpeedLimitation extends Limitation {
	 ...
	 *  Or...
	 *  
	 *  The speed limit of the recharging, measured in stamina per second or
	 *  in stamina per cycle. */
	...
	public String fullToXML(int identation) {
		...
		// fills the buffer
		buffer.append("<limitation type=\"" + LimitationTypes.SPEED_LIMITATION + "\">\n");
