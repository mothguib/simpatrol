...
public final class StaminaLimitation extends Limitation {
	 ...
	 * 
	 *  In the case of a permission for a perception, or a permission
	 *  for a compound action, this value will be reduce from the
	 *  agent's stamina in every cycle / second. */
	private double cost;
	
	/* Methods. */
	/** Constructor.
	 * 
	 *  @param cost The cost of stamina associated with the permission. */
