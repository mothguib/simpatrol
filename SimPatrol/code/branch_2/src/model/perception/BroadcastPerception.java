...
/**
 * Implements the hability of an agent to receive broadcasted messages.
 * 
 * The production of broadcast perceptions can be determined only by stamina
 * limitations.
 * 
...
public final class BroadcastPerception extends Perception {
	 ...
	 * 
	 * @param message
	 *            The message bradcasted to the agent.
	 */
