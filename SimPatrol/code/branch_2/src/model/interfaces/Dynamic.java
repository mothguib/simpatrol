...
public interface Dynamic {	
	/** Returns the probability distribution for the enabling time
	 *  of the dynamic object.
	 *  
	 *  @return The event time probability distribution for the enabling of the object. */
	public EventTimeProbabilityDistribution getEnablingTPD();
	
	/** Returns the probability distribution for the disabling time
	 *  of the dynamic object.
	 *  
	 *  @return The event time probability distribution for the disabling of the object. */
	 ...
	 * 
	 *  @param is_enabled TRUE, if the object is enabled, FALSE if not. */
