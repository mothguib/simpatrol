...
public abstract class Society implements XMLable {
	...
	/**
	 * Verifies if a given agent exists in this society.
	 * 
	 * @param agent
	 *            The agent to be verified.
	 * @return TRUE if the agent was in this society successfully, FALSE if not.
	 */
	public boolean hasAgent(Agent agent) {
		// registers if the agent exists in the society
