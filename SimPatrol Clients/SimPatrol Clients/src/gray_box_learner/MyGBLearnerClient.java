 ...
 */
public final class MyGBLearnerClient extends Client {
	/* Methods. */
	/**
	 * Constructor.
	 * 
	 ...
	 */
	public MyGBLearnerClient(String remote_socket_address,
	...
	public static void main(String[] args) {
		...
		try {
			...
			MyGBLearnerClient client = new MyGBLearnerClient(
