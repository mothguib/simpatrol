...
public class Test_Message_Client  extends Client {
	 ...
	 */
	public Test_Message_Client(String remote_socket_address,
	...
	protected void createAndStartAgents(String[] agent_ids, int[] socket_numbers)
		...
		for (int i = 0; i < agent_ids.length; i++) {
			Test_Message_Agent agent = new Test_Message_Agent(agent_ids[i]);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Test_Message_Client client = new Test_Message_Client(
			...
			System.out
					.println("Usage \"java test_agent.Test_Message_Client\n"
