 ...
 * [2005].
 */
public final class CycledAgent2 extends Agent {
	/* Attributes. */
	...
	private String current_vertex_id;
	 ...
	 */
	private synchronized boolean perceiveOrientation(String perception) {
		if (perception.indexOf("<perception type=\"3\"") > -1) {
			System.err.println("orientation ok...");
			...
			if (agent_id.equals(this.id)) {
				...
				if (this.current_vertex_id != null
						&& this.current_plan_step == -1) {
					this.current_plan_step = this.PLAN
							.indexOf(this.current_vertex_id);
					System.err.println("Started on step "
							+ this.current_plan_step + ", vertex "
							+ this.current_vertex_id);
				}
	...
	private boolean perceivePosition(String perception) {
		if (perception.indexOf("<perception type=\"4\"") > -1) {
			...
			if (!vertex_id.equals(this.current_vertex_id)) {
				// updates it
				this.current_vertex_id = vertex_id;
	...
	private void visitAndGoToNextStep() throws IOException {
		...
		String next_vertex_id = this.PLAN.get(this.current_plan_step);
		this.connection.send("<action type=\"1\" vertex_id=\"" + next_vertex_id
				+ "\"/>");
	...
	public void run() {
		...
		while (!this.stop_working) {
			...
			if (!received_orientation) {
				this.id = "a1";
				this
						.perceiveOrientation("<perception type=\"3\" message=\"a1###v45,v46,v6,v5,v4,v3,v2,v1,v2,v3,v4,v5,v6,v47,v48,v49,v48,v47,v6,v7,v8,v9,v10,v11,v12,v42,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,v22,v23,v24,v25,v26,v27,v28,v29,v30,v31,v32,v33,v34,v35,v36,v37,v38,v39,v40,v41,v40,v39,v38,v37,v36,v35,v34,v33,v32,v31,v30,v29,v28,v27,v26,v25,v24,v23,v22,v21,v20,v19,v18,v43,v44###0;0\"");
	...
	public static void main(String args[]) {
		try {
			...
			CycledAgent2 agent = new CycledAgent2();
