...
public class AgentImage {
	...
	public AgentImage(String id, String label, int state, String node_id, String edge, double elapsed_length, double stamina, double max_stamina, 
