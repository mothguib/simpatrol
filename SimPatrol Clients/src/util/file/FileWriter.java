...
public class FileWriter {
     ...
     * 
     *  @param c The character to be written into the file. */
     ...
     * 
     *  @param i The integer value to be written into the file. */
     ...
     * 
     *  @param d The double value to be written into the file. */
    public void print(double d) {
    	this.out.print(d);
    }
    
    /** Writes the given double into the file, respecting
     *  the given number of decimal places.
     *  
     *  If a value smaller than 1 is passed as the number of decimal
     *  places, only the rounded integer part will be printed.
     *  
     *  @param d The double value to be written into the file.
     *  @param dec The number of digital places to be considered. */
    ...
    /** Writes the given double, respecting the given number of
     *  decimal places, and a new line into the file.
     *  
     *  If a value smaller than 1 is passed as the number of decimal
     *  places, only the rounded integer part will be printed.
     *  
    ...
    /** Returns the string that represents the given double rounded
     *  by the given number of decimal places.
     *  
     *  @param d The double value to be written into the file.
     *  @param dec The number of digital places to be considered.
