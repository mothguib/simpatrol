 ...
 * de uma aresta � dada pelo M�XIMO das gravidades presentes naquela 
 * dire��o da aresta.
 * 
...
public class GravityManagerMax extends GravityManager {
	...
	private double addToGravList(int destiny, int destinyPred, GravInfo gravInfo) {
		...
		return gravLists[destiny][destinyPred].getMinimum().gravity; //obs: a chave m�nima tem gravidade m�xima
	}
