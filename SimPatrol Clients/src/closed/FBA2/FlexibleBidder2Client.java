...
/**
 * Client for the FlexibleBidderAgent2 class
 * 
 * @author pouletc
 *
 */
public class FlexibleBidder2Client extends Client {
	
	double idleness_rate_for_path, idleness_rate_for_auction;
	String env_file;
	

	public FlexibleBidder2Client(String remote_socket_address, int remote_socket_number,
	...
	public static void main(String[] args) {
		System.out.println("Flexible Bidder agents 2!");
		...
		try {
			...
			FlexibleBidder2Client client = new FlexibleBidder2Client(
