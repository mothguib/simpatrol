...
public class QTable {
	...
	public QTable(int states_count, int actions_count, double e,
		...
		for (int i = 0; i < this.VALUES.length; i++){	
			...
			int numOfAction = Integer.valueOf(line.substring(0, line.indexOf("/")));
			this.ACTIONS_PER_STATE_COUNT[i] = numOfAction;
			...
			while(line.indexOf(";") > -1){
				...
				line = line.substring(line.indexOf(",") + 1);
				int use = Integer.valueOf(line.substring(0, line.indexOf(";")));
