...
public class MyGBCommonLearnerClient extends Client {
	/* Methods. */
	 ...
	 */
	public MyGBCommonLearnerClient(String remote_socket_address,
	...
	public static void main(String[] args) {
		...
		try {
			...
			MyGBCommonLearnerClient client = new MyGBCommonLearnerClient(
