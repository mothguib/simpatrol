 ...
 * 
 */
public final class CognitiveCoordinatorAgent_OLD extends Agent_OLD {
	/* Attributes. */
	...
	/* Methods. */
	/** Constructor. */
	public CognitiveCoordinatorAgent_OLD(int num_agent) {
		this.graph = null;
	...
	public static void main(String args[]) {
		try {
			...
			CognitiveCoordinatorAgent_OLD coordinator = new CognitiveCoordinatorAgent_OLD(num_agents);
