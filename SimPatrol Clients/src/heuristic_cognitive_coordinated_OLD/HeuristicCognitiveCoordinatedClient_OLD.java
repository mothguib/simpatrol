/* HeuristicCognitiveCoordinatedClient.java */
 ...
 * sequence.
 */
public final class HeuristicCognitiveCoordinatedClient_OLD extends Client_OLD {
	/* Methods. */
	/**
	 * Constructor.
	 * 
	 ...
	 */
	public HeuristicCognitiveCoordinatedClient_OLD(String remote_socket_address,
	...
	public static void main(String[] args) {
		...
		try {
			...
			HeuristicCognitiveCoordinatedClient_OLD client = new HeuristicCognitiveCoordinatedClient_OLD(
			...
			System.out
					.println("Usage \"java heuristic_cognitive_coordinated.HeuristicCognitiveCoordinatedClient\n"
