 ...
 */
public final class HeuristicCognitiveCoordinatorAgent_OLD extends Agent_OLD {
	/* Attributes. */
	...
	/* Methods. */
	/** Constructor. */
	public HeuristicCognitiveCoordinatorAgent_OLD() {
		this.graph = null;
	...
	public static void main(String args[]) {
		try {
			...
			HeuristicCognitiveCoordinatorAgent_OLD coordinator = new HeuristicCognitiveCoordinatorAgent_OLD();
