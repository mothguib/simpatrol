...
public class CycledCoordinatorAgent_OLD extends Agent_OLD {
	...
	/* Methods. */
	/** Constructor. */
	public CycledCoordinatorAgent_OLD(boolean use_precise_solution) {
	...
	public static void main(String args[]) {
		try {
			...
			CycledCoordinatorAgent_OLD coordinator = new CycledCoordinatorAgent_OLD(use_precise_solution);
