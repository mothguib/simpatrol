 ...
 */
public class GrayBoxLearnerAgent_OLD extends Agent_OLD {
	/* Attributes. */
	...
	/* Methods. */
	/** Constructor. */
	public GrayBoxLearnerAgent_OLD() {
	...
	public static void setQtableDirectory(String q_table_dir) {
		GrayBoxLearnerAgent_OLD.q_table_dir = q_table_dir;
	}
	...
	private int[] getStateItemValues() {
		int[] stateItemValues;
		int nextIndex = 0;
		if (GrayBoxLearnerAgent_OLD.GENERALIZED) {
	...
	public void run() {
		...
		this.learning_engine = new QLearningEngine(state_item_values,
				GrayBoxLearnerAgent_OLD.q_table_dir + this.id + ".txt");
	...
	public static void main(String args[]) {
		try {
			...
			GrayBoxLearnerAgent_OLD.configureLearningEngine(e, alfa_decay_rate,
