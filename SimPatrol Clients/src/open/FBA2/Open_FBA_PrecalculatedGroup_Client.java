...
public class Open_FBA_PrecalculatedGroup_Client  extends Client {
	double idleness_rate_for_path, idleness_rate_for_auction;
	String env_file;
	

	public Open_FBA_PrecalculatedGroup_Client(String remote_socket_address, int remote_socket_number,
	...
	public static void main(String[] args) {
		System.out.println("Open FBA Agents - coop by node group 2 strategy!");
		...
		try {
			...
			Open_FBA_PrecalculatedGroup_Client client = new Open_FBA_PrecalculatedGroup_Client(
			...
			System.out
					.println("Usage \"java FBA_Open.Open_FBA_coopByNodGroup2_Client \n"
