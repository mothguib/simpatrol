...
public class Open_FBA_Nodes_Client  extends Client {
	double idleness_rate_for_path, idleness_rate_for_auction;
	String env_file;
	

	public Open_FBA_Nodes_Client(String remote_socket_address, int remote_socket_number,
	...
	public static void main(String[] args) {
		...
		try {
			...
			Open_FBA_Nodes_Client client = new Open_FBA_Nodes_Client(
