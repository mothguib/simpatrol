...
public class Open_FBA_Proximity_Client  extends Client {
	double idleness_rate_for_path, idleness_rate_for_auction;
	double max_dist;
	String env_file;
	

	public Open_FBA_Proximity_Client(String remote_socket_address, int remote_socket_number,
	...
	public static void main(String[] args) {
		System.out.println("Open FBA Agents - coop by node strategy!");
		...
		try {
			...
			Open_FBA_Proximity_Client client = new Open_FBA_Proximity_Client(
					remote_socket_address, remote_socket_number,
					environment_file_path, log_file_path, time_of_simulation,
					is_real_time_simulator, idleness_rate_for_path, idleness_rate_for_auction, max_dist);
			client.start();
		} catch (Exception e) {
			System.out
					.println("Usage \"java FBA_Open.Open_FBA_coopByNode2_Client \n"
