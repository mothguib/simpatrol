...
public class OpenCRClient extends Client {
	String env_file;
	 ...
	 */
	public OpenCRClient(String remote_socket_address,
				...
				for(SocietyImage soc : societies)
					if(!soc.id.equals("InactiveSociety"))
						...
						for (int i = 0; i < soc.agents.length; i++) {
							...
							Agent agent = new OpenCRAgent(soc.agents[i].id, soc.agents[i].enter_time, soc.agents[i].quit_time, soc.agents[i].Society_to_join);
	...
	public static void main(String[] args) {
		System.out.println("Open Conscientious Reactive agents!");
		...
		try {
			...
			OpenCRClient client = new OpenCRClient(
			...
			System.out
					.println("Usage \"java conscientious_reactive.OpenCRClient.java\n"
