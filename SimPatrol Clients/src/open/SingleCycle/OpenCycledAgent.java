...
public class OpenCycledAgent extends OpenAgent {
	...
	/** Constructor. */
	public OpenCycledAgent(String id) {
		super(id);
	...
	public OpenCycledAgent(String id, double entering_time, double quitting_time, String society_id) {
