...
public class OpenCycledClient extends Client {
	String env_file;
	 ...
	 */
	public OpenCycledClient(String remote_socket_address,
					...
					if(!soc.id.equals("InactiveSociety"))
						...
						for (int i = 0; i < soc.agents.length; i++) {
							...
							if (agent_ids[corresponding_id].equals("coordinator"))
								...
								agent = new OpenCycledAgent(soc.agents[i].id, soc.agents[i].enter_time, soc.agents[i].quit_time, soc.agents[i].Society_to_join);
	...
	public static void main(String[] args) {
		...
		try {
			...
			OpenCycledClient client = new OpenCycledClient(
