...
public class Minimax_Agent extends Cooperative_Agent {
	
	protected double MAX_DIST;
	
	

	public Minimax_Agent(String id, int number_of_agents,
	...
	public Minimax_Agent(String id, double entering_time, double quitting_time, 
