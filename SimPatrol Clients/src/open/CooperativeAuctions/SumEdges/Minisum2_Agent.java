...
public class Minisum2_Agent extends Minisum_Agent {
	...
	public Minisum2_Agent(String id, int number_of_agents,
			LinkedList<String> nodes, double idleness_rate_for_path) {
		super(id, number_of_agents, nodes, idleness_rate_for_path);
	}
	
	public Minisum2_Agent(String id, double entering_time, double quitting_time, 
