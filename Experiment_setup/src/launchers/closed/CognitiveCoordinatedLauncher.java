...
import closed.CognitiveCoordinated.CognitiveCoordinatedAgent;
import closed.CognitiveCoordinated.CognitiveCoordinatorAgent;
 ...
 */
public final class CognitiveCoordinatedLauncher extends Launcher {
	/* Methods. */
	/**
	 * Constructor.
	 * 
	 ...
	 */
	public CognitiveCoordinatedLauncher(String environment_dir_path, 
	...
	public static void main(String[] args) {
		...
		try {
			...
			CognitiveCoordinatedLauncher client = new CognitiveCoordinatedLauncher(
			...
			System.out
					.println("Usage \"java launchers.CognitiveCoordinatedLauncher\n"
