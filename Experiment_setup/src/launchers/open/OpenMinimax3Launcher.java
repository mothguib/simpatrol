...
import open.CooperativeAuctions.AvEdges.Minimax3_Agent;
...
public class OpenMinimax3Launcher extends Launcher {
	...
	public OpenMinimax3Launcher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		System.out.println("Minimax Agents - average of edges heuristic");
		...
		try {
			...
			OpenMinimax3Launcher client = new OpenMinimax3Launcher(
			...
			System.out
					.println("Usage \"java Minimax3 Agents! \n"
							...
							+ "<rate of idleness in calculating heuristic destination>");
		}
	}
