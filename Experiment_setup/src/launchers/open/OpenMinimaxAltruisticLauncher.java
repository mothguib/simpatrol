...
public class OpenMinimaxAltruisticLauncher extends Launcher {
	...
	public OpenMinimaxAltruisticLauncher(String environment_dir_path, String env_gen_name,
		...
		for(SocietyImage soc : societies)
			if(!soc.id.equals("InactiveSociety"))
				for (int i = 0; i < soc.agents.length; i++) {
					...
					Agent agent = new Minimax_Agent_altruistic(soc.agents[i].id, -1, soc.agents[i].quit_time, 
				...
				for (int i = 0; i < soc.agents.length; i++) {
					...
					Agent agent = new Minimax_Agent_altruistic(ordered_agents[i].id, ordered_agents[i].enter_time, ordered_agents[i].quit_time, 
	...
	public static void main(String[] args) {
		...
		try {
			...
			OpenMinimaxAltruisticLauncher client = new OpenMinimaxAltruisticLauncher(
