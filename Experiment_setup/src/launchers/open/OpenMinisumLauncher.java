...
public class OpenMinisumLauncher extends Launcher {

	
	double idleness_rate_for_path;
	String env_file;
	
	public OpenMinisumLauncher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		System.out.println("Minisum Agents - path length heuristic");
		...
		try {
			...
			OpenMinisumLauncher client = new OpenMinisumLauncher(
			...
			System.out
					.println("Usage \"java Minisum Agents! \n"
