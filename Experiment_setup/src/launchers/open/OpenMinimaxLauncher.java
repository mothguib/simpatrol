...
import open.FBA2.Open_FBA_Group_Agent;
...
public class OpenMinimaxLauncher extends Launcher {
	...
	public OpenMinimaxLauncher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		...
		try {
			...
			OpenMinimaxLauncher client = new OpenMinimaxLauncher(
