...
import open.CooperativeAuctions.SumEdges.Minimax2_Agent;
...
public class OpenMinimax2Launcher extends Launcher {
	...
	public OpenMinimax2Launcher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		System.out.println("Minimax Agents - sum of edges heuristic");
		...
		try {
			...
			OpenMinimax2Launcher client = new OpenMinimax2Launcher(
			...
			System.out
					.println("Usage \"java Minimax2 Agents! \n"
