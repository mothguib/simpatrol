...
import open.CooperativeAuctions.SumEdges.Minisum2_Agent;
...
public class OpenMinisum2Launcher extends Launcher {

	
	double idleness_rate_for_path;
	String env_file;
	
	public OpenMinisum2Launcher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		System.out.println("Minisum Agents - sum of edges heuristic");
		...
		try {
			...
			OpenMinisum2Launcher client = new OpenMinisum2Launcher(
			...
			System.out
					.println("Usage \"java Minisum2 Agents! \n"
