...
import open.CooperativeAuctions.AvEdges.Minisum3_Agent;
...
public class OpenMinisum3Launcher extends Launcher {

	
	double idleness_rate_for_path;
	String env_file;
	
	public OpenMinisum3Launcher(String environment_dir_path, String env_gen_name,
	...
	public static void main(String[] args) {
		System.out.println("Minisum Agents - average of edges heuristic");
		...
		try {
			...
			OpenMinisum3Launcher client = new OpenMinisum3Launcher(
					environment_dir_path, 
					env_gen_name, numEnv, 
					log_dir_path, log_gen_name, 
					time_of_simulation, idleness_rate_for_path);
			client.start();
		} catch (Exception e) {
			System.out
					.println("Usage \"java Minisum3 Agents! \n"
