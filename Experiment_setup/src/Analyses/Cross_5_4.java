...
public class Cross_5_4 {
	...
	public static void main(String[] args) {
		...
		for(String nb_agent : nbAgents){
			String[] logs_dir;
			if(nb_agent.equals("4")|| nb_agent.equals("5")){
				logs_dir = new String[]{
					"0_" + nb_agent + "_limited/logs_RandReact/log_", 
					"0_" + nb_agent + "_limited/logs_ConsReact/log_",
					"1_" + nb_agent + "/logs_Cycled/log_", 
					"1_" + nb_agent + "/logs_Cycled/log_",
					"1_" + nb_agent + "/logs_Cycled/log_",
					"1_" + nb_agent + "/logs_CognCoord/log_", 
					"1_" + nb_agent + "/logs_HeurCogCoord/log_"};
				last_cycle = last_cycle_1;
			} else {
				logs_dir = new String[]{
						"0_" + nb_agent + "_limited/logs_RandReact/log_", 
						"0_" + nb_agent + "_limited/logs_ConsReact/log_",
						"1_" + nb_agent + "/logs_Cycled/fast/log_", 
						"1_" + nb_agent + "/logs_Cycled/slow/log_", 
						"1_" + nb_agent + "/logs_Cycled/slow2/log_",
						"1_" + nb_agent + "/logs_CognCoord/log_", 
						"1_" + nb_agent + "/logs_HeurCogCoord/log_"};
