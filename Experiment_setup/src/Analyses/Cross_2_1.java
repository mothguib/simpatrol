...
public class Cross_2_1 {
	...
	public static void main(String[] args) {
		...
		for(String nb_agent : nbAgents){
			String[] logs_dir;
			if(nb_agent.equals("1")|| nb_agent.equals("2")){
				logs_dir = new String[]{
...
//		myviewer.addCurve(myfreq, myvalues2_0, Color.blue, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_0, Color.blue, DrawStyle.POINT_CROSS);
...
//		myviewer.addCurve(myfreq, myvalues2_1, Color.red, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_1, Color.red, DrawStyle.POINT_PLUS);
...
//		myviewer.addCurve(myfreq, myvalues2_4, Color.orange, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_4, Color.orange, DrawStyle.POINT_CROSS);
...
//		myviewer.addCurve(myfreq, myvalues2_5, Color.gray, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_5, Color.gray, DrawStyle.POINT_PLUS);
