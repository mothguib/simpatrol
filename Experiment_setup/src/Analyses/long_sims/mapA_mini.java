...
public class mapA_mini {

	public static void main(String[] args) {
		String global_path = "/home/pouletc/experimentation/Simulations/mapA/";

		String[] agents_name = { "SC", "HPCC", "Minimax", "Minimax selfish", "Minimax altruistic"};
		...
		String[] logs_dir = new String[]{
				...
				"0_long/logs_MinimaxSelfish/log_",
				"0_long/logs_MinimaxAltruistic/log_"};
