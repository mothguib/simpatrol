...
public class Cross_4_5_FBA {
	public static void main(String[] args) {
		String global_path = "/home/pouletc/experimentation/Simulations/islands/";
		String[] nbAgents = {"14", "15", "14_15"};
		
		String[] agents_name = { "random", "node", "group", "proximity 8", "proximity 16", "proximity 24"};
		...
		AverageMetricsReport[] MyAvReports = new AverageMetricsReport[18];
		...
		for(String nb_agent : nbAgents){
			...
			if(nb_agent.equals("14")|| nb_agent.equals("15")){
				...
				logs_dir = new String[]{
						"0_" + nb_agent + "_open/logs_OpenFBARandom/log_",
						"0_" + nb_agent + "_open/logs_OpenFBANodes/log_",
						"0_" + nb_agent + "_open/logs_OpenFBANodesGroup/log_",
		...
		Double[] myvalues21_4 = MyAvReports[6].getAvAverageIdleness_curb(freq);
		Double[] myvalues21_5 = MyAvReports[7].getAvAverageIdleness_curb(freq);
		
		System.out.println();
		System.out.println("Transition phase 1000 -> 1800");
		System.out.println();
		
		Double max0 = -1d, max1 = -1d, max2 = -1d, max3 = -1d, max4 = -1d, max5 = -1d;
		Double turnmax0 = 0d, turnmax1 = 0d, turnmax2 = 0d, turnmax3 = 0d, turnmax4 = 0d, turnmax5 = 0d;
		...
		myviewer.addCurve(myfreq, myvalues21_5, Color.pink, DrawStyle.POINT_ROUND);
		...
		Double[] mymaxvalues21_4 = MyAvReports[6].getAvMaxIdleness_curb(freq);
		Double[] mymaxvalues21_5 = MyAvReports[7].getAvMaxIdleness_curb(freq);
		
		Double maxmax0 = -1d, maxmax1 = -1d, maxmax2 = -1d, maxmax3 = -1d, maxmax4 = -1d, maxmax5 = -1d;
		Double turnmaxmax0 = 0d, turnmaxmax1 = 0d, turnmaxmax2 = 0d, turnmaxmax3 = 0d, turnmaxmax4 = 0d, turnmaxmax5 = 0d;
		for(int i = 1000/freq; i < 1800/freq; i++){
		...
		myviewer2.addCurve(myfreq, mymaxvalues21_5, Color.pink, DrawStyle.POINT_ROUND);
