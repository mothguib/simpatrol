...
public class Cross_25_24 {
	...
	public static void main(String[] args) {
		...
		for(String nb_agent : nbAgents){
			String[] logs_dir;
			if(nb_agent.equals("24")|| nb_agent.equals("25")){
				logs_dir = new String[]{
		...
		myviewer.addCurve(myfreq, myvalues1_1, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_PLUS);
//		myviewer.addCurve(myfreq, myvalues2_1, Color.red, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_1, Color.black, DrawStyle.POINT_PLUS);
