...
public class Cross_10_9 {
	...
	public static void main(String[] args) {
		...
		AverageMetricsReport[] MyAvReports = new AverageMetricsReport[21];
		...
		for(String nb_agent : nbAgents){
			String[] logs_dir;
			if(nb_agent.equals("9")|| nb_agent.equals("10")){
				logs_dir = new String[]{
		...
		Double max0 = -1d, max1 = -1d, max2 = -1d, max3 = -1d, max4 = -1d, max5 = -1d, max6 = -1d;
		Double turnmax0 = 0d, turnmax1 = 0d, turnmax2 = 0d, turnmax3 = 0d, turnmax4 = 0d, turnmax5 = 0d, turnmax6 = 0d;
		for(int i = 1000/freq; i < 2000/freq; i++){
		...
		myviewer.addCurve(myfreq, myvalues21_0, Color.black, DrawStyle.POINT_CROSS);
		
		myviewer.addCurve(myfreq, myvalues1_1, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_ROUND);
//		myviewer.addCurve(myfreq, myvalues2_1, Color.red, DrawStyle.LONG_DOTS);
		myviewer.addCurve(myfreq, myvalues21_1, Color.black, DrawStyle.POINT_ROUND);
...
//		myviewer.addCurve(myfreq, myvalues21_4, Color.orange, DrawStyle.POINT_ROUND);
		...
		CurveViewer myviewer4 = new CurveViewer("Average Idleness");
		myviewer4.addCurve(myfreq, myvalues1_5, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_PLUS);
//		myviewer.addCurve(myfreq, myvalues2_5, Color.gray, DrawStyle.LONG_DOTS);
		myviewer4.addCurve(myfreq, myvalues21_5, Color.black, DrawStyle.POINT_PLUS);
		
		myviewer4.addCurve(myfreq, myvalues1_6, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer.addCurve(myfreq, myvalues2_6, Color.pink, DrawStyle.LONG_DOTS);
		myviewer4.addCurve(myfreq, myvalues21_6, Color.black, DrawStyle.POINT_CROSS);
		
		myviewer4.setXdivision(250);
		myviewer4.setYdivision(10);
		myviewer4.setVisible(true);
		
		
		
		CurveViewer myviewer3 = new CurveViewer("Average Idleness");
//		myviewer3.addCurve(myfreq, myvalues1_0, Color.blue, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer3.addCurve(myfreq, myvalues2_0, Color.blue, DrawStyle.LONG_DOTS);
//		myviewer3.addCurve(myfreq, myvalues21_0, Color.blue, DrawStyle.POINT_ROUND);
//		
//		myviewer3.addCurve(myfreq, myvalues1_1, Color.red, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer3.addCurve(myfreq, myvalues2_1, Color.red, DrawStyle.LONG_DOTS);
//		myviewer3.addCurve(myfreq, myvalues21_1, Color.red, DrawStyle.POINT_ROUND);
//		
//		myviewer3.addCurve(myfreq, myvalues1_2, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer3.addCurve(myfreq, myvalues2_2, Color.cyan, DrawStyle.LONG_DOTS);
		myviewer3.addCurve(myfreq, myvalues21_2, Color.black, DrawStyle.POINT_CROSS);
		
//		myviewer3.addCurve(myfreq, myvalues1_3, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_ROUND);
//		myviewer3.addCurve(myfreq, myvalues2_3, Color.green, DrawStyle.LONG_DOTS);
		myviewer3.addCurve(myfreq, myvalues21_3, Color.black, DrawStyle.POINT_ROUND);
		
		myviewer3.addCurve(myfreq, myvalues1_4, Color.black, DrawStyle.SHORT_DOTS, DrawStyle.POINT_PLUS);
//		myviewer3.addCurve(myfreq, myvalues2_4, Color.orange, DrawStyle.LONG_DOTS);
		myviewer3.addCurve(myfreq, myvalues21_4, Color.black, DrawStyle.POINT_PLUS);
		
//		myviewer3.addCurve(myfreq, myvalues1_5, Color.gray, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer3.addCurve(myfreq, myvalues2_5, Color.gray, DrawStyle.LONG_DOTS);
//		myviewer3.addCurve(myfreq, myvalues21_5, Color.gray, DrawStyle.POINT_ROUND);
//		
//		myviewer3.addCurve(myfreq, myvalues1_6, Color.pink, DrawStyle.SHORT_DOTS, DrawStyle.POINT_CROSS);
//		myviewer3.addCurve(myfreq, myvalues2_6, Color.pink, DrawStyle.LONG_DOTS);
...
//		
		...
		Double maxmax0 = -1d, maxmax1 = -1d, maxmax2 = -1d, maxmax3 = -1d, maxmax4 = -1d, maxmax5 = -1d, maxmax6 = -1d;
		Double turnmaxmax0 = 0d, turnmaxmax1 = 0d, turnmaxmax2 = 0d, turnmaxmax3 = 0d, turnmaxmax4 = 0d, turnmaxmax5 = 0d, turnmaxmax6 = 0d;
		for(int i = 1000/freq; i < 2000/freq; i++){
		...
		for(Double stabrate : stab){
			...
			for(int tAg = 0; tAg < agents_name.length; tAg++){
				...
				System.out.println(avturn / MyAvReports[2*agents_name.length + tAg].size());
			}
		}
	}
