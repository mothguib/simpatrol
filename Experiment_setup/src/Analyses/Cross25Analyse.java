...
public class Cross25Analyse {
	...
	public static void main(String[] args) {
		...
		myviewer.setXdivision(200);
		myviewer.setYdivision(1000);
		...
		*/
		...
		myfreq = new Double[(end-start)/freq2 +1];
		for(int i = 0; i < myfreq.length; i++)
			myfreq[i] = start + (double) i * freq2;
		
		myvalues0 = MyAvReports[0].getAvAverageIdleness_curb(freq2, start, end);
		myvalues1 = MyAvReports[1].getAvAverageIdleness_curb(freq2, start, end);
		myvalues2 = MyAvReports[2].getAvAverageIdleness_curb(freq2, start, end);
		myvalues3 = MyAvReports[3].getAvAverageIdleness_curb(freq2, start, end);
		myvalues4 = MyAvReports[4].getAvAverageIdleness_curb(freq2, start, end);
		
		CurveViewer myviewer3 = new CurveViewer("Average Idleness");
		myviewer3.addCurve(myfreq, myvalues0, Color.blue);
		myviewer3.addCurve(myfreq, myvalues1, Color.red);
		myviewer3.addCurve(myfreq, myvalues2, Color.cyan, DrawStyle.LONG_DOTS);
		myviewer3.addCurve(myfreq, myvalues3, Color.orange, DrawStyle.LONG_DOTS);
		myviewer3.addCurve(myfreq, myvalues4, Color.gray, DrawStyle.SHORT_DOTS);
		myviewer3.setXcenter(start);
		myviewer3.setXdivision(200);
