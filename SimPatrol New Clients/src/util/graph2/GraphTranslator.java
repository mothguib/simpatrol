...
public abstract class GraphTranslator {
	 ...
	 */
	public static Graph[] parseAndGetGraphs(String message) throws SAXException, IOException {
		return getGraphs(parseString(message));
	}

	public static Graph[] getGraphs(Element xmlElement) {
