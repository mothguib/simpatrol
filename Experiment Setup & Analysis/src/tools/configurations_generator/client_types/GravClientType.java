...
public class GravClientType extends ClientType {	
	
	public GravClientType(int firstAgentTypeQuantity, String propag, String mass, String exp, String comb) {
		this.agentTypes = new AgentType[2];
		this.name = "grav(" + propag +"," + mass + "," + exp + "," + comb + ")";
		
		//Agentes normais
		int[] allowedPerceptions1 = {3, 4};
		int[] allowedActions1 = {1, 2, 3};
		this.agentTypes[0] = new AgentType(firstAgentTypeQuantity,
				allowedPerceptions1, allowedActions1, "ag");
